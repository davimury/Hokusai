<template>
  <div
    class="bg-lightergray text-white pb-6 justify-center items-center overflow-hidden w-full sm:w-1/3 lg:w-1/4 rounded-lg shadow-sm m-2"
  >
    ...
    <div class="mt-8">
      <h1 class="text-lg text-center font-semibold">{{ cardData.name }}</h1>
    </div>
  </div>
</template>
